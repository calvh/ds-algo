...
from algorithms.graphs.dfs_directed import *

g = Graph()

g.add_vertex("BOS", explored=False, active=False)
g.add_vertex("JFK", explored=False, active=False)
g.add_vertex("DFW", explored=False, active=False)
g.add_vertex("LAX", explored=False, active=False)
g.add_vertex("ORD", explored=False, active=False)
g.add_vertex("SFO", explored=False, active=False)
g.add_vertex("MIA", explored=False, active=False)
